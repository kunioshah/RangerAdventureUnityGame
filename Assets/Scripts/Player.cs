...
public class Player : MonoBehaviour
{
    ...
    string[][] dialog = new string[][]
    {
        ...
        new string[]{"Aww, look at these baby birds!",
        "You know. we could probably find out who their parents are.",
        "How? Oh, it's simple!",
        "We can look at their traits!",
        "These birds have dark blue eyes with blue specks and white skin.",
        "Two of them have short beaks, one of them has a medium size one.",
        "We can see what genes may have caused this.",
        "Here, I'll pull up a diagram. This is called a punnet square.",
        "Those letters are called alleles. Alleles are your genes.",
        "Each parent passes down one allele for each trait. Both alleles together form your genotype.",
        "That's both of those letters together.",
        "Each letter represents a different trait. "},
        //new string[]{""},
        //new string[]{""}
    };
